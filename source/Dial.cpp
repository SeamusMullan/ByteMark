...
Dial::Dial (const juce::String& labelText,
...
void Dial::resized()
{
    ...
    label.setFont (juce::Font (static_cast<float> (label.getHeight()) * 0.7f));
    textBox.setFont (juce::Font (static_cast<float> (textBox.getHeight()) * 0.7f));
